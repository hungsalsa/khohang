            ...
            <ul class="nav side-menu">
               <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= Yii::$app->homeUrl; ?>hangxe">Hãng xe</a></li>
               ...
               <li>
                  ...
                  <ul class="nav child_menu">
                     <li><a href="<?= Yii::$app->homeUrl.'user'; ?>"><i class="fa fa-user"></i>Thành viên</a></li>
                     <li><a href="<?= Yii::$app->homeUrl.'khachhang'; ?>"><i class="fa fa-user"></i>Khách hàng</a></li>
                     <li><a href="<?= Yii::$app->homeUrl.'nhacungcap'; ?>"><i class="fa fa-user"></i>Nhà cung cấp</a></li>
                  </ul>
               </li>
               <li>
                  <a><i class="fa fa-database"></i> Trang sản phẩm <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     <li><a href="<?= Yii::$app->homeUrl.'mathang'; ?>">Mặt hàng</a>
               ...
               <li>
                  <a><i class="fa fa-money"></i> Quản lý đơn hàng <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
